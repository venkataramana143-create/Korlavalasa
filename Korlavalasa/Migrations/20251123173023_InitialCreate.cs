...
namespace Korlavalasa.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainCrops = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ContactEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContactNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SarpanchName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SecretaryName = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VillageInfo", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Gallery_UploadDate",
                table: "Gallery",
                column: "UploadDate");

            migrationBuilder.CreateIndex(
                name: "IX_News_IsActive",
                table: "News",
                column: "IsActive");
